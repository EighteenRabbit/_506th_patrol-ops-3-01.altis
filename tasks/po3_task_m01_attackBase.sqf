...
[ format["TASK%1",PO3_TASK__IDD],
	...
	(PO3_side_1 select 0),
	[format["MRKR%1",PO3_TASK__IDD],PO3_TASK__POS,"mil_objective",(PO3_side_3 select 0) call PO3_fnc_getUnitMarkerColour,format[localize "STR_PO3_M01_TITLE",_locaname]],
	"assigned",
	(PO3_TASK__POS),
	format[localize "STR_PO3_M01_TITLE",_locaname]
