...
JWC_MaxD = 500;                                // Max distance in meters allowed between requester and target
...
JWC_disallowedMunition = ["NAPALM"];              // Add names of disallowed munition: "JDAM", "CBU" or "NAPALM"
...
JWC_CASarray = ["CAS1","CAS2","CAS3","CAS4","CAS5","CAS6","CAS7","CAS8","CAS9","CAS10","CAS11","CAS12","CAS13","CAS14","CAS15","CAS16","CAS17","CAS18","CAS19","CAS20","CAS21","CAS22","CAS23","CAS24","controller","controller_1","controller_2","s3ops"];         // Add CAS init names to this array. 
