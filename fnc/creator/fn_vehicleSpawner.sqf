...
_dir		= if(_counThis > 2) then { _this select 2 }else{ random 359 };
...
["PO3_fnc_vehicleSpawner",format["Vehicle Group %1 Created at %2 with %3 Units in a %4, Skill %5",_grp,_position,count (units _grp)] ] call PO3_fnc_log;
