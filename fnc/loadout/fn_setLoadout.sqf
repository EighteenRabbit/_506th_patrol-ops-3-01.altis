...
private ["_target","_data","_loadedMagazines","_placeholderCount","_add","_outfit","_addWeapon","_addPrimary","_addHandgun","_addSecondary","_addOrder","_currentWeapon","_currentMode"];

_target = _this select 0;
_data = _this select 1;

if(typeName _data == "BOOL") then {
	if(_data) then { _data = PO3_VAR_savedLoadout }else{ _data = nil };
};
