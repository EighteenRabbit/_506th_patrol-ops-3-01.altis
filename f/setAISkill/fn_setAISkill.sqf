...
if (typeName _skillset == typeName false) then {
	...
	switch (_faction) do {
		...
		// Opfor
			case "tec_csat": {f_var_skillOpfA}; 					// CSAT Alternative
...
switch (_PARAM_Debug) do
	...
	// Yes
		case 1:
		{
			// CSAT Katiba Tracer Replacement
			if ((_unit hasWeapon "arifle_Katiba_F") or (_unit hasWeapon "arifle_Katiba_C_F") or (_unit hasWeapon "arifle_Katiba_GL_F") or
				(_unit hasWeapon "arifle_Katiba_C_ACO_pointer_F") or (_unit hasWeapon "arifle_Katiba_C_ACO_F") or (_unit hasWeapon "arifle_Katiba_ACO_F") or
				(_unit hasWeapon "arifle_Katiba_pointer_F") or (_unit hasWeapon "arifle_Katiba_ACO_pointer_F") or (_unit hasWeapon "arifle_Katiba_ARCO_F") or
				(_unit hasWeapon "arifle_Katiba_ARCO_pointer_F") or (_unit hasWeapon "arifle_Katiba_GL_ACO_F") or (_unit hasWeapon "arifle_Katiba_GL_ARCO_pointer_F") or 
				(_unit hasWeapon "arifle_Katiba_GL_ACO_pointer_F") or (_unit hasWeapon "arifle_Katiba_GL_Nstalker_pointer_F") or (_unit hasWeapon "arifle_Katiba_GL_ACO_pointer_snds_F") or
				(_unit hasWeapon "arifle_Katiba_C_ACO_pointer_snds_F") or (_unit hasWeapon "arifle_Katiba_ACO_pointer_snds_F") or (_unit hasWeapon "arifle_Katiba_ARCO_pointer_snds_F")) then {
			...
			// Russian AK74M Tracer Replacement
			if ((_unit hasWeapon "rhs_weap_ak74m") or (_unit hasWeapon "rhs_weap_ak74m_dtk") or (_unit hasWeapon "rhs_weap_ak74m_pkas") or
				(_unit hasWeapon "rhs_weap_ak74m_1p63") or (_unit hasWeapon "rhs_weap_ak74m_pso1m2") or (_unit hasWeapon "rhs_weap_ak74m_1p29") or
				(_unit hasWeapon "rhs_weap_ak74m_camo") or (_unit hasWeapon "rhs_weap_ak74m_camo_dtk") or (_unit hasWeapon "rhs_weap_ak74m_npz") or
				(_unit hasWeapon "rhs_weap_ak74m_npz_dtk") or (_unit hasWeapon "rhs_weap_ak74m_desert_npz") or (_unit hasWeapon "rhs_weap_ak74m_camo_npz") or
				(_unit hasWeapon "RHS_WEAP_AK74M_GP25") or (_unit hasWeapon "rhs_weap_ak74m_gp25_dtk") or (_unit hasWeapon "rhs_weap_ak74m_gp25_npz") or
				(_unit hasWeapon "rhs_weap_ak74m_gp25_npz_dtk") or (_unit hasWeapon "rhs_weap_ak74m_gp25_pkas") or (_unit hasWeapon "rhs_weap_ak74m_gp25_1p63") or
				(_unit hasWeapon "rhs_weap_ak74m_gp25_pso1m2") or (_unit hasWeapon "rhs_weap_ak74m_gp25_1p29")) then {
					{ if ( _x in primaryWeaponMagazine _unit ) then { _unit removeMagazines _x; _unit removePrimaryWeaponItem _x; } } forEach magazines _unit;
					_unit addPrimaryWeaponItem "rhs_30Rnd_545x39_AK_green";
					_unit addMagazines ["rhs_30Rnd_545x39_AK_green",7]; 
			};
			
			// AAF Mk20 Tracer Replacement
			if ((_unit hasWeapon "arifle_Mk20_F") or (_unit hasWeapon "arifle_Mk20_plain_F") or (_unit hasWeapon "arifle_Mk20C_F") or
				(_unit hasWeapon "arifle_Mk20C_plain_F") or (_unit hasWeapon "arifle_Mk20_GL_F") or (_unit hasWeapon "arifle_Mk20_GL_plain_F") or
				(_unit hasWeapon "arifle_Mk20C_ACO_F") or (_unit hasWeapon "arifle_Mk20C_ACO_pointer_F") or (_unit hasWeapon "arifle_Mk20_pointer_F") or
				(_unit hasWeapon "arifle_Mk20_Holo_F") or (_unit hasWeapon "arifle_Mk20_ACO_F") or (_unit hasWeapon "arifle_Mk20_ACO_pointer_F") or
				(_unit hasWeapon "arifle_Mk20_MRCO_F") or (_unit hasWeapon "arifle_Mk20_MRCO_plain_F") or (_unit hasWeapon "arifle_Mk20_MRCO_pointer_F") or
				(_unit hasWeapon "arifle_Mk20_GL_MRCO_pointer_F	") or (_unit hasWeapon "arifle_Mk20_GL_ACO_F") or (_unit hasWeapon "arifle_TRG20_ACO_F") or
				(_unit hasWeapon "arifle_TRG21_MRCO_F") or (_unit hasWeapon "arifle_TRG21_F")) then {
					{ if ( _x in primaryWeaponMagazine _unit ) then { _unit removeMagazines _x; _unit removePrimaryWeaponItem _x; } } forEach magazines _unit;
